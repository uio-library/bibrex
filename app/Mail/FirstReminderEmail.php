    ...
    public function __construct(Loan $loan)
    {
        ...
        switch ($lang) {
            ...
            case 'eng':
                ...
                $view_args = [
                    'indefinite' => $thing->properties->name_indefinite->eng,
                    'definite' => $thing->properties->name_definite->eng,
            ...
            default:
                $subject = s($this->subjectTpl[$lang])
                    ->replace('{thing}', $thing->properties->name_definite->nob)
                    ->upperCaseFirst();
                    ;
                $view = 'emails.first_reminder.nob_html';
                $view_args = [
                    'indefinite' => $thing->properties->name_indefinite->nob,
                    'definite' => $thing->properties->name_definite->nob,
                    'relativeTime' => $loan->relativeCreationTime(),
