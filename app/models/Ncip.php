...
class Ncip {
	...
	public function __construct($url, $options = array())
	{
		...
		$this->user_agent = array_get($options, 'user_agent', 
			'UBO Scriptotek Dalek/0.1 (+http://labs.biblionaut.net/)');

		$this->namespaces = array_get($options, 'namespaces', 
			array('ns1' => 'http://www.niso.org/2008/ncip'));

		$this->bibkode = array_get($options, 'bibkode', 'k');
	}
		...
		$request = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
			<ns1:NCIPMessage xmlns:ns1="http://www.niso.org/2008/ncip" ns1:version="http://www.niso.org/schemas/ncip/v2_01/ncip_v2_01.xsd">
			    <ns1:CheckOutItem>
			        ...
			        <ns1:ItemId>
			           <ns1:AgencyId>' . $this->bibkode . '</ns1:AgencyId>
